...
RUN_DIR="runs/sac_full_before_stop_warmstart_20k_v2_wandb"
CONFIG="configs/sac_full_before_stop_warmstart_20k_wandb.yaml"
...
echo "full_before_stop_warmstart_postprocess=complete"
